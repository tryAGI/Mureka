...
internal static class CliRuntime
{
    ...
    public static async Task<global::Mureka.MurekaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Mureka.ApiException exception)
    {
        var builder = new StringBuilder();
