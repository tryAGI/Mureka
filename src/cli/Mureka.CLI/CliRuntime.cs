...
{
    private const string UserSecretsId = "Mureka.CLI";
    private const string UserSecretApiKeyName = "MUREKA_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"MUREKA_API_KEY"];
    private const string CredentialFileDirectoryName = ".mureka";

    public static async global::System.Threading.Tasks.Task<global::Mureka.MurekaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        return new global::Mureka.MurekaClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("MUREKA_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Mureka.ApiException exception)
    {
        var builder = new StringBuilder();
