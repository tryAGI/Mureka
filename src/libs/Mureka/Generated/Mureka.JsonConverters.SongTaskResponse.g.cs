...
{
    /// <inheritdoc />
    public class SongTaskResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mureka.SongTaskResponse>
    {
        /// <inheritdoc />
        public override global::Mureka.SongTaskResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("data.choices")) __score1++;
            if (__jsonProps.Contains("data.created_at")) __score1++;
            if (__jsonProps.Contains("data.failed_reason")) __score1++;
            if (__jsonProps.Contains("data.finished_at")) __score1++;
            if (__jsonProps.Contains("data.id")) __score1++;
            if (__jsonProps.Contains("data.model")) __score1++;
            if (__jsonProps.Contains("data.progress")) __score1++;
            if (__jsonProps.Contains("data.status")) __score1++;
            if (__jsonProps.Contains("data.task_id")) __score1++;
            if (__jsonProps.Contains("data.watermarked")) __score1++;
            ...
            global::Mureka.SongTaskResponseVariant2? songTaskResponseVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mureka.SongTaskResponseVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mureka.SongTaskResponseVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Mureka.SongTaskResponseVariant2).Name}");
                        songTaskResponseVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (@base == null && songTaskResponseVariant2 == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mureka.BaseResponse), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mureka.BaseResponse> ??
            ...
            var __value = new global::Mureka.SongTaskResponse(
                @base,
        ...
        public override void Write(
            ...
            global::Mureka.SongTaskResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsSongTaskResponseVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mureka.SongTaskResponseVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mureka.SongTaskResponseVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Mureka.SongTaskResponseVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.SongTaskResponseVariant2!, typeInfo);
            }
        }
    }
}