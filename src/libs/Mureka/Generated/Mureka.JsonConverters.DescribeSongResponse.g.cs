...
{
    /// <inheritdoc />
    public class DescribeSongResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mureka.DescribeSongResponse>
    {
        /// <inheritdoc />
        public override global::Mureka.DescribeSongResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("resp_data.description")) __score1++;
            if (__jsonProps.Contains("resp_data.genres")) __score1++;
            if (__jsonProps.Contains("resp_data.instrument")) __score1++;
            if (__jsonProps.Contains("resp_data.tags")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::Mureka.DescribeSongResponseVariant2? describeSongResponseVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Mureka.DescribeSongResponse(
                @base,
        ...
        public override void Write(
            ...
            global::Mureka.DescribeSongResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsDescribeSongResponseVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mureka.DescribeSongResponseVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mureka.DescribeSongResponseVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Mureka.DescribeSongResponseVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.DescribeSongResponseVariant2!, typeInfo);
            }
        }
    }
}